...
@section('title', 'Dokter | Tambah Jadwal Dokter')
...
<div class="container-fluid">
    ...
    <form action="{{ route('jadwal-dokter.store') }}" method="POST" enctype="multipart/form-data">

        @csrf
        <div class="mb-3" style="margin-top: 2%;">
            <label class="form-label">Dokter</label><br>
            <select class="form-control input-length select2" id="doctor_id" name="doctor_id" style="width: auto;">
            ...
            <div class="row input-clock-length">
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="time" class="form-control" id="senin_1" name="senin_1" value="" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="input-group clockpicker" id="senin2">
                        <input type="time" class="form-control" id="senin_2" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3" style="margin-top: 2%;">
            ...
            <div class="row input-clock-length">
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="time" class="form-control" id="selasa_1" name="selasa_1" value="" autocomplete="off">
                    </div>
                </div>
                <div style="margin-top: 0.5%;">
                    -
                ...
                <div class="col-md-5">
                    <div class="input-group clockpicker" id="selasa2">
                        <input type="time" class="form-control" id="selasa_2" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3" style="margin-top: 2%;">
            ...
            <div class="row input-clock-length">
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="time" class="form-control" id="rabu_1" name="rabu_1" value="" autocomplete="off">
                    </div>
                </div>
                <div style="margin-top: 0.5%;">
                    -
                ...
                <div class="col-md-5">
                    <div class="input-group clockpicker" id="rabu2">
                        <input type="time" class="form-control" id="rabu_2" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3" style="margin-top: 2%;">
            ...
            <div class="row input-clock-length">
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="time" class="form-control" id="kamis_1" name="kamis_1" value="" autocomplete="off">
                    </div>
                </div>
                <div style="margin-top: 0.5%;">
                    -
                ...
                <div class="col-md-5">
                    <div class="input-group clockpicker" id="kamis2">
                        <input type="time" class="form-control" id="kamis_2" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3" style="margin-top: 2%;">
            ...
            <div class="row input-clock-length">
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="time" class="form-control" id="jumat_1" name="jumat_1" value="" autocomplete="off">
                    </div>
                </div>
                <div style="margin-top: 0.5%;">
                    -
                ...
                <div class="col-md-5">
                    <div class="input-group clockpicker" id="jumat2">
                        <input type="time" class="form-control" id="jumat_2" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3" style="margin-top: 2%;">
            ...
            <div class="row input-clock-length">
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="time" class="form-control" id="sabtu_1" name="sabtu_1" value="" autocomplete="off">
                    </div>
                </div>
                <div style="margin-top: 0.5%;">
                    -
                ...
                <div class="col-md-5">
                    <div class="input-group clockpicker" id="sabtu2">
                        <input type="time" class="form-control" id="sabtu_2" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3" style="margin-top: 2%;">
            ...
            <div class="row input-clock-length">
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="time" class="form-control" id="minggu_1" name="minggu_1" value="" autocomplete="off">
                    </div>
                </div>
                <div style="margin-top: 0.5%;">
                    -
                ...
                <div class="col-md-5">
                    <div class="input-group clockpicker" id="minggu2">
                        <input type="time" class="form-control" id="minggu_2" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
