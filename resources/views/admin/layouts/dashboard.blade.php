    ...
    <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ url('/admin/products') }}">Products</a>
                <a class="collapse-item" href="{{ url('/admin/admins') }}">Admins</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ url('/admin/buttons') }}">Buttons</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ url('/admin/color') }}">Colors</a>
                <a class="collapse-item" href="{{ url('/admin/border') }}">Borders</a>
                <a class="collapse-item" href="{{ url('/admin/animation') }}">Animations</a>
                <a class="collapse-item" href="{{ url('/admin/other') }}">Other</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ url('/admin/password') }}">Forgot Password</a>
